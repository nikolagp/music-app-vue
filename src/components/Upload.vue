  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); // reference: music-app-2402.appspot.com
        const songsRef = storageRef.child(`songs/${file.name}`); // child to the ref: music-app-2402.appspot.com/songs/example.mp3
